...
################################
## (The stock QoR placement pblocks — m65driver / sdcard / vga — are removed
## here: they target flat-hierarchy cells that live inside the RM in the DFX
## carve-out, and their empty pblocks would overlap the RP (DRC HDPR-66).)
